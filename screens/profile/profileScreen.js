...
const ProfileScreen = ({ navigation }) => {
      ...
      <View style={styles.activityInfoWrapStyle}>
        ...
        <View style={{ flex: 1, marginLeft: Sizes.fixPadding + 5.0 }}>
          <Text numberOfLines={1}>
            ...
            <Text style={{ ...Fonts.whiteColor14Medium }}>{item.soldTo}</Text>
          </Text>
  ...
  function tabBarOption({ option, index }) {
    return (
      ...
      >
        <Text style={{ ...Fonts.whiteColor16SemiBold }}>{option}</Text>
      </TouchableOpacity>
    );
  }
    ...
    return (
      <View style={styles.otherInfoWrapStyle}>
        <View style={{ alignItems: "center" }}>
          <Text style={{ ...Fonts.whiteColor16SemiBold }}>10.0K</Text>
          <Text style={{ lineHeight: 12.0, ...Fonts.grayColor12Regular }}>
            Items
          </Text>
        </View>
        <View style={{ alignItems: "center" }}>
          <Text style={{ ...Fonts.whiteColor16SemiBold }}>6.3K</Text>
          <Text style={{ lineHeight: 12.0, ...Fonts.grayColor12Regular }}>
            Owners
          </Text>
        </View>
        ...
        <View style={{ alignItems: "center" }}>
          <Text style={{ ...Fonts.whiteColor16SemiBold }}>391.6K</Text>
          <Text style={{ lineHeight: 12.0, ...Fonts.grayColor12Regular }}>
            Traded
          </Text>
        </View>
    ...
    return (
      <View style={styles.linkAndSocialMediaInfoWrapStyle}>
        <View style={styles.linkWrapStyle}>
          <Text style={{ ...Fonts.grayColor14Regular }}>ZqsdDsef6iuP0F00s</Text>
          <MaterialCommunityIcons
            name="content-copy"
            size={18}
      ...
      <View style={{ marginBottom: Sizes.fixPadding * 2.0 }}>
        ...
        <View style={styles.profileInfoWrapStyle}>
          <View style={{ flex: 1, flexDirection: "row", alignItems: "center" }}>
            ...
            />
            <View style={{ flex: 1, marginLeft: Sizes.fixPadding + 5.0 }}>
              <Text style={{ ...Fonts.whiteColor18SemiBold }}>JOSEPHREESE</Text>
          ...
          >
            <Text style={{ ...Fonts.whiteColor16SemiBold }}>Edit</Text>
          </TouchableOpacity>
        </View>
      </View>
    );
