...
const EditProfileScreen = ({ navigation }) => {
  ...
  const { name, userName, email, phoneNumber, showBottomSheet } = state;
        ...
        >
          ...
          >
            {changeProfilePicOptionsSort({
              bgColor: "#009688",
              icon: (
                <Entypo name="camera" size={18} color={Colors.whiteColor} />
              ),
              option: "Camera",
            })}
            {changeProfilePicOptionsSort({
  ...
  function userNameInfo() {
    return (
      <View style={{ margin: Sizes.fixPadding * 2.0 }}>
        <Text style={{ ...Fonts.grayColor12Regular }}>Username</Text>
        <TextInput
          value={userName}
