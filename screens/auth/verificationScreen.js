...
import { SafeAreaView, Dimensions, View, StatusBar, ScrollView, StyleSheet, TextInput, Text, TouchableOpacity } from "react-native";
...
const VerificationScreen = ({ navigation }) => {
    ...
    function loading() {
        return (
            ...
            >
                <View style={{ marginVertical: Sizes.fixPadding * 2.0, backgroundColor: Colors.bodyBackColor, alignItems: 'center', }}>
                    <CircleFade size={56} color={Colors.primaryColor} />
                    <Text style={{ ...Fonts.whiteColor14Medium, marginTop: Sizes.fixPadding * 2.0 }}>
                        Please wait...
                    </Text>
                </View>
            </Dialog.Container>
