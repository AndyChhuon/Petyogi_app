...
const LiveAuctionsDetailScreen = ({ navigation, route }) => {
    ...
    return (
      ...
      >
        ...
        <Text style={{ marginTop: Sizes.fixPadding + 5.0 }}>
          ...
          <Text style={{ ...Fonts.whiteColor14SemiBold }}>3D CUBE</Text>
          <Text style={{ ...Fonts.grayColor14Regular }}>
            {} by {}
          </Text>
          <Text style={{ ...Fonts.whiteColor14SemiBold }}>@cryptopenks</Text>
        </Text>
        <View style={styles.coinInfoWrapStyle}>
          <TouchableOpacity
            activeOpacity={0.9}
            onPress={() => {
              ethValue > 1 ? updateState({ ethValue: ethValue - 1 }) : null;
            }}
        ...
        >
          ...
          <Text style={{ ...Fonts.whiteColor14SemiBold }}>1.2 ETH</Text>
        </View>
        <View
          style={{
        ...
        >
          <Text style={{ ...Fonts.grayColor14Regular }}>Service fee</Text>
          <Text style={{ ...Fonts.whiteColor14SemiBold }}>0.012 ETH</Text>
        </View>
        <View
          style={{
            flexDirection: "row",
        ...
        >
          ...
          <Text style={{ ...Fonts.primaryColor14SemiBold }}>1.212 ETH</Text>
        </View>
        <View
          style={{
        ...
        >
          <TouchableOpacity
            activeOpacity={0.9}
            onPress={() =>
              updateState({ agreeWithTermsOfService: !agreeWithTermsOfService })
            }
            style={{
              ...styles.checkBoxStyle,
              backgroundColor: agreeWithTermsOfService
                ? Colors.primaryColor
                : Colors.bodyBackColor,
              borderColor: agreeWithTermsOfService
                ? Colors.primaryColor
                : Colors.whiteColor,
            }}
          >
        ...
        >
          <Text style={{ ...Fonts.whiteColor20SemiBold }}>Place a Bid</Text>
        </TouchableOpacity>
      </BottomSheet>
    );
  }
      ...
      <View style={styles.bidInfoWrapStyle}>
        <View style={{ flex: 1, flexDirection: "row", alignItems: "center" }}>
          ...
          <View style={{ flex: 1, marginLeft: Sizes.fixPadding + 5.0 }}>
            <Text style={{ ...Fonts.whiteColor16Medium }}>{item.userName}</Text>
  ...
  function auctionImage() {
    return (
      <Image source={item.auctionImage} style={styles.auctionImageStyle} />
    );
  }
  ...
  function auctionInfo() {
    return (
      ...
      >
        ...
        >
          <Text style={{ ...Fonts.whiteColor20Bold }}>{item.auctionName}</Text>
        ...
        >
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vel amet
          bibendum ut erat. Egestas eget enim elit bibendum nullam. Massa
          molestie ipsum porttitor molestie.
        </Text>
        <View
          style={{
            flexDirection: "row",
        ...
        >
          <View style={{ flex: 1, flexDirection: "row", alignItems: "center" }}>
            ...
            />
            <View style={{ flex: 1, marginLeft: Sizes.fixPadding + 5.0 }}>
              <Text style={{ ...Fonts.whiteColor18SemiBold }}>CryptoPenks</Text>
